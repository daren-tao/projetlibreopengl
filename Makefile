#############################################################################
# Makefile for building: projet_libre_opengl
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  projet_libre_opengl.pro
# Template: app
# Command: C:\Qt\5.3\mingw482_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile projet_libre_opengl.pro
#############################################################################
...
Makefile: projet_libre_opengl.pro C:/Qt/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
